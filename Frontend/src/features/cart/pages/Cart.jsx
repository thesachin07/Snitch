...
const Cart = () => {
    ...
    const changeQty = useAppStore((state) => state.changeQty)
    const incrementCartItem = useAppStore((state) => state.incrementCartItem)
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
                        ...
                        <div className="w-full lg:w-[65%]">
                            ...
                            <div className="flex flex-col gap-6">
                                {cart.items.map(item => {
                                    const { product, variant: variantId, price, _id: itemId } = item
